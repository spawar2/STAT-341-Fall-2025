...
Probability & Statistics I & II, Biostatistics, Data Analysis (topics including descriptive & inferential statistics, variable types (qualitative, quantitative), distribution properties, discrete & continuous types, R functions, probability distributions, Hypothesis testing using using critical value (Probability, F Statistics, Coefficient) ANOVA, T-test, correlation, chi-Square, regression, etc.). Regression (linear, multiple, logistic), Probability distributions (Discrete, Binomial, Poisson, Continuous Uniform, Chi-squared, Student-t, Fisher,)  Exponential, Normal, Chi-Square test), Hypothesis testing using using critical value (Probability, F Statistics, Coefficient) Analysis of Variance (ANOVA), data wrangling, Post Hoc Test. Data wrangling and handling. Custom functions in R.
